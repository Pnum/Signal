	...
	Generator
		Cellular
			Worley
				get2(x, y)
					if(SIGNAL_USE_DLL)
						return text2num(call(SIGNAL_DLL_PATH, __DLL_WORLEY2)(num2text(x), num2text(y), num2text(seed), num2text(distance_function), num2text(coeff_1), num2text(coeff_2), num2text(coeff_3), num2text(coeff_4)))
				...
				get3(x, y, z)
					if(SIGNAL_USE_DLL)
						return text2num(call(SIGNAL_DLL_PATH, __DLL_WORLEY3)(num2text(x), num2text(y), num2text(z), num2text(seed), num2text(distance_function), num2text(coeff_1), num2text(coeff_2), num2text(coeff_3), num2text(coeff_4)))
